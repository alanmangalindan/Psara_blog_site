// Code to process images uploaded in the Froala editor @jingyuan
...
function upload (req, callback) {
    // The route to where the image will be saved on the server
    var fileRoute = "/public/uploads/images/";
    ...
    busboy.on("file", function(fieldname, file, filename, encoding, mimetype) {
        ...
        // var randomName = 'test' + "." + getExtension(filename);
